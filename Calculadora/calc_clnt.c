...
float *
suma_1(struct Operacion *argp, CLIENT *clnt)
{
...
float *
resta_1(struct Operacion *argp, CLIENT *clnt)
{
	static float clnt_res;
...
float *
multiplicacion_1(struct Operacion *argp, CLIENT *clnt)
{
	static float clnt_res;
...
float *
division_1(struct Operacion *argp, CLIENT *clnt)
{
	static float clnt_res;
